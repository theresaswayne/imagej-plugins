...
//	  input is a single bright-field image from a confocal Z stack, 
//    the RBC area is detected using a Weka model, 
//    and binary processing is performed on the classified image.
