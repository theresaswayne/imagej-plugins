...
Modified dialog parameter names to make the command macro-recordable, by Theresa Swayne tcs6@cumc.columbia.edu, 2016
*/
...
Dialog.addNumber("Line_thickness =", 1,0,2,"pixels");
...
Dialog.addCheckbox("Dense_Points_x4 (x4 of regular)", true);
Dialog.addChoice("Regular points color:", newArray("cyan", "red", "yellow", "green", "blue", "magenta", "orange", "black", "white"));
Dialog.addChoice("Dense_points_color:", newArray("green", "yellow", "red", "blue", "cyan", "magenta", "orange", "black", "white"));
Dialog.addMessage("          TEST LINES:");
Dialog.addCheckbox("Horizontal_segmented", true);
Dialog.addCheckbox("Vertical_segmented", false);
Dialog.addCheckbox("Horizontal_solid (x3 of segmented)", false);
Dialog.addCheckbox("Vertical_solid (x3 of segmented)", false);
Dialog.addChoice("Line_color:", newArray("cyan", "red", "green", "magenta", "blue", "yellow", "orange", "black", "white")); 
Dialog.addHelp(html);
Dialog.show(); 
