...
// @String (label= "Text to match") matchText
// @String (label= "Type of match", choices={"Exact", "Contains"}, style="radioButtonHorizontal") matchOption
	...
	for (j=1; j<=seriesCount; j++) 
    	{
		    ...
		    if (tileTest >= 0) {
				textAfterName = substring(text, n1, n1+100);
	        ...
	        if((matchOption == "equals" && name == matchText) || (matchOption == "contains" && indexOf(name, matchText) >= 0)) {
