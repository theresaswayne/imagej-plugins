...
/*
 * - splits multi-Series files into TIFF. 
 * - each series is saved as one tiff. The name of the series is appended to the file name.
 * 
 *  Based on a macro by Martin Hoehne and azim58
 *  Updated 2023-25, Theresa Swayne: use script parameters, use standard batch functions to process folder and image, works with ND2s and other multi-series images
 */
