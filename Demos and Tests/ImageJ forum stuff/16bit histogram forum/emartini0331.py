...
for n_roi in range(0,rm.getCount()):
    ...
    for r in nonzero:               
        ...
        value_presents.append(r);
    #update changed values (where then calculate the whole histogram)
       
# calculate HISTOGRAM of specific r value of all roi     
value_presents_set=set(map(str,value_presents));
rt.show("Results") 
#print(value_presents_set)
for i in value_presents_set:
    r=int(i);
