...
# Assumptions:
# Each field of view is represented by one CSV file 
# Required cols: filename, Label, timepoint (others are ignored)
# filename data contains experiment and ROI name in the pattern Wellxx ROIy FrameZZZ.csv
# Label data is of the format objA1_objB7 
# Outputs:
...
# To use: 
# 1) Generate merged colocalization files, one per imaging field, using combine_csv_files_with_num.R
#     Place all files in the same folder          
# 2) Edit Parameters section (object names, time window, interaction threshold) as needed
# 3) Source the script; when prompted, open the folder containing the files
