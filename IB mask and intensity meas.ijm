...
print(channel1Name," is the image we will look for");
channel2Name = basename + "_C2";

imageCalculator("OR create stack", channel1Name,channel2Name);
selectWindow("Result of "+channel1Name);
...
run("Set Measurements...", "area mean min integrated display redirect=&channel1Name decimal=3");
run("Analyze Particles...", "display exclude stack");

selectWindow("inclusion_mask");
run("Set Measurements...", "area mean min integrated display redirect=&channel2Name decimal=3");
run("Analyze Particles...", "display exclude stack");
